...
class _CameraViewState extends State<CameraView> {
  ...
  void initState() {
    ...
    DetectEyeData().leftEyeImage = null;
    DetectEyeData().rightEyeImage = null;
    DetectEyeData().mode = DetectMode.Calib;
  }
  ...
  Widget _cropImage() {
    // if (img != null) {
    final list = [];
    // if (DetectEyeData.instance.leftEyeJpeg != null && DetectEyeData.instance.rightEyeJpeg != null) {
    //   // final a = imglib.encodeBmp(img!);
    //   list.add(Image.memory(DetectEyeData.instance.leftEyeJpeg!));
    //   list.add(Image.memory(DetectEyeData.instance.rightEyeJpeg!));
    //   return Positioned(
    //     top: 100,
    //     left: 100,
